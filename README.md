...
module "eks_blueprints" {
  ...
  subnet_ids        = ["<subnet-a>", "<subnet-b>", "<subnet-c>"]     # Enter Private Subnet IDs
...
| <a name="module_eks"></a> [eks](#module\_eks) | terraform-aws-modules/eks/aws | v18.28.0 |
